    ...
    messageList: [
      {
        ...
        con: '微软开发者大会，请各界技术爱好者参加，欢迎报名' +
          '<img src="../../imgs/emotion/Expression_1.png" style="widht:20px;height:20px;vertical-align: middle;"/> 开发者大会',
...
function uploadFiles(self, imgPaths, index) {
  wx.uploadFile({
    url: "https://www.xx.xx/ok/uploadfile",  //上传的接口地址
...
function face(obj) {
  let emotion = emotionFun();
  let emotionHost="https://www.xx.xx/";
  let face = {};
